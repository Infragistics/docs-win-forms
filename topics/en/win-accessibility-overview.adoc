...
Several of our controls use the AccessibleObject, and are fully accessible to applications such as Narrator and Magnifier. Keep in mind, this technology is useful only for visual controls and components; some {ProductName} controls and components are not visual, and therefore do not implement accessibility.
