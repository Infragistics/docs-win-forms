...
Starting with 2011 Volume 2 of {ProductName}, users can interact with the User Interface (UI) of the application while the export process is executing. This capability, supported by all WinGrid™ export components (WinGridDocumentExporter™, WinGridExcelExporter™, and WinGridWordWriter™) is achieved through exporting the grid asynchronously.
