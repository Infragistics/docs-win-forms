...
This release introduces a new theme – the IG Theme – that can be applied to all controls in {ProductName}. This theme is dominantly monochromatic with the use of blacks, whites and some grays, with blue as a highlight/accent color.
