...
The {ProductName} 2009 Volume 2 release includes new controls and a number of powerful new features and functionalities to allow you to take even more advantage of our Windows Forms controls and components.
