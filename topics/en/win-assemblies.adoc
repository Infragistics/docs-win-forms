...
In this topic, you'll find a list of all the Windows Forms assemblies included in the {ProductName} product, along with their corresponding controls and components.
...
This section contains topics that list all the resource strings used by each {ProductName} assembly, along with the string's default text value.