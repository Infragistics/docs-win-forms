...
View WinCheckEditor in the Office 2007 look and feel by setting the  pick:[win-forms="link:{ApiPlatform}win.ultrawineditors~infragistics.win.ultrawineditors.ultratoggleeditorbase~glyphinfo.html[GlyphInfo]"]  property to Office2007, and UseOsThemes to False.
