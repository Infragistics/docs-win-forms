...
{ProductName} provides two tab elements to choose from: the WinTab™ and the WinTabStrip™. Both elements share features, and both can be used to provided a tab-based interface to your application. Which element you will use depends on the context in which the tabs will be displayed.
