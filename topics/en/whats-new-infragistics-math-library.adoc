...
Starting with 2011 Volume 2 of {ProductName}, the Infragistics Math Library provides you with a unified set of core functions that allow you to perform a large range of mathematical operations that are fast, accurate and memory efficient. In addition, the library allows you to:
