...
The {ProductName} controls and components offer several powerful, yet flexible means of changing their appearance.
...
The PLF is the platform on which all {ProductName} controls/components are built. This powerful architecture give you infinite control over almost every UI aspect of the elements. To learn more about the PLF and how you can use it to style your Windows Forms controls, see the link:win-plf-overview.html[PLF Overview].