...
With the 2011 Volume 2 release of {ProductName}, your solutions can run the latest version of the CLR4 framework and take advantage of our assemblies using the same CLR version.
