...
These topics contain important tips and notes on installing {ProductName}:

* link:introduction-tips-for-installing-infragistics-windows-forms.html[Tips for Installing {ProductName}]
