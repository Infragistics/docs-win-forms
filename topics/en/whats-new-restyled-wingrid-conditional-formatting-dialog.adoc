...
With 2011 Volume 2 of {ProductName}, the WinGrid™ control’s conditional formatting dialog has been restyled to provide users with a more intuitive user interface (UI), while providing the same powerful functionality.
