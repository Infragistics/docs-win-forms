...
In {ProductName} 2006 Volume 2, several refinements were made to our controls in order to support Application Styling. Included in these refinements were several method signature changes. Below is a list of methods that were modified in this release.
