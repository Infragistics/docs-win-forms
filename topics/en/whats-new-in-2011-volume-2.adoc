...
The {ProductName} 2011 Volume 2 release includes new components, features, and functionalities that allow you to take even more advantage of our Windows Forms controls and components.
