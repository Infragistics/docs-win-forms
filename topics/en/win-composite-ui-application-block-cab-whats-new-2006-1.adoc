...
Click the link below to learn about the new Infragistics CAB Extensibility Kit™ add-on that provides seamless integration with the CAB framework to allow enterprise development teams to build sophisticated smart client applications using the feature-rich {ProductName} toolset.
