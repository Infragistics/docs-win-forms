...
This topic provides an overview of the new functionalities and components introduced with the {ProductName} 2012 Volume 1 release.
...
Starting with 2012 Volume 1 of {ProductName}, end-users can print the content of the UltraGanttView™ used in your application. This is achieved through a new component called UltraGanttViewPrintDocument™ which is added to the Windows Forms toolset. This component gives you full control over positioning and customization of legends in the printed document, in a way similar to that of the Microsoft® Project.
