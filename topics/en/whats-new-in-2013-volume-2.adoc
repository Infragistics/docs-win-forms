...
The following table summarizes the new features of the {ProductName} 2013 Volume 2. Additional details follow the table.
...
<table cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <p>The <span class="ig-italic">WinLiveTileView</span> control is new to {ProductName} family of controls in
        ...
        <tr>
            ...
            <td>
                <p>The <span class="ig-italic">WinRadialMenu</span> component is another addition to {ProductName} family of
