...
In {ProductName} 2006 Volume 3, we added an editing counterpart to WinFormattedLinkLabel™: the WinFormattedTextEditor™ control. Using the WinFormattedTextEditor control, you can display any of the formatted text that WinFormattedLinkLabel can display, but with the addition of editing support.
