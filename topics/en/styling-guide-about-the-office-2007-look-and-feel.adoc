...
In {ProductName} 2006 Volume 3, we added a new look and feel to our controls: the Microsoft® Office 2007 look and feel. This look and feel is unique in the way that it comes in three separate colors: Blue, Black, and Silver. You can change back and forth between these colors by using the  pick:[win-forms="link:{ApiPlatform}win{ApiVersion}~infragistics.win.office2007colortable~colorscheme.html[ColorScheme]"]  property off the  pick:[win-forms="link:{ApiPlatform}win{ApiVersion}~infragistics.win.office2007colortable.html[Office2007ColorTable]"]  object.
