...
This is an existing property. {ProductName} 2005 Volume 2 and older versions did not support RowSizing modes of AutoFixed and AutoFree and Free in Row-Layout mode. This feature request is for supporting those modes when Row-Layout functionality is being used. {ProductName} 2005 Volume 3 now implements these modes in Row-Layout.
