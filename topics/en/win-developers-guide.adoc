...
A framework is a collection of .NET objects that form the foundation of a particular toolset. In our case, all of our {ProductName} controls and components are built upon the link:win-presentation-layer-framework-plf.html[Presentation Layer Framework™ (PLF)].
