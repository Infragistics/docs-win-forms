...
The application programming interface (API) is the foundation for all of our Windows Forms controls and components. The API Reference Guide offers a definitive listing of all the {ProductName} classes, enumerations, interfaces, and delegates -- organized by Windows Forms assembly.
...
* link:{ApiPlatform}win.codeduitest.uia.vs12{ApiVersion}.html[Infragistics.Win.CodedUITest.UIA.VS12]
* link:{ApiPlatform}win.codeduitest.uia.vs14{ApiVersion}.html[Infragistics.Win.CodedUITest.UIA.VS14]
* link:{ApiPlatform}win.codeduitest.uia.vs15{ApiVersion}.html[Infragistics.Win.CodedUITest.UIA.VS15]
* link:{ApiPlatform}win.codeduitest.uia.vs16{ApiVersion}.html[Infragistics.Win.CodedUITest.UIA.VS16]
...
* link:{ApiPlatform}win.ultrawincalcmanager.formulabuilder{ApiVersion}.html[Infragistics.Win.UltraWinCalcManager.FormulaBuilder]
