...
*Note:* For information on deploying {ProductName} assemblies used in your application, see link:win-deploying-your-application.html[Deploying Your Application].
