...
Starting with 2011 Volume 2 of {ProductName}, several new additions to the Infragistics Excel Library are now available. The new features include data validation, print areas, page breaks, print titles, and predefined shapes.
