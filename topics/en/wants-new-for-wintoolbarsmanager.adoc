...
With the release of Office 2010, Microsoft® provides their users the ability to customize the layout of the Ribbon within each Office application. This release of {ProductName} 2011 Volume 1 provides the ability for end users to modify WinToolbarsManager™ component’s Ribbon layout, in a similar manner.
