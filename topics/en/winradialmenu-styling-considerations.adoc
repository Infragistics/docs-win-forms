...
For more information refer to the link:styling-guide-setting-up-your-application-for-styling.html[Setting Up Your Application for Styling] topic on how to create style library files with  _AppStylist_   for radial menu or any other  _{ProductName}_   controls in general.
