...
Starting with 2011 Volume 2 of {ProductName}, the grid filtering functionality works the same as the filtering behavior of Microsoft Excel®. Excel filters the list of cell values to only include the values that have not been filtered out by other columns.
