...
The WinControlContainerEditor™ component provides you with the ability to easily embed non-editor controls (e.g. WinChart™, WinGrid™), custom user controls, or any other control into one of the {ProductName} suite of controls that support embeddable editors.
