...
Visual Studio® 2005 (.NET Framework 2.0) provides a number of new and exciting features. Infragistics has strived to make sure its {ProductName} controls are compatible with these new features. Below is a list of Visual Studio 2005 features that were implemented in our Windows Forms controls and components.
