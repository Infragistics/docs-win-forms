...
The {ProductName} 2010 Volume 1 release includes a number of new controls and powerful new features and functionalities to allow you to take even more advantage of our Windows Forms controls and components.
