...
With this release of {ProductName} controls we provide you the new WinTimeSpanEditor™ control. You can now use this editor to edit TimeSpan data types. The WinTimeSpanEditor control implements the IProvidesEmbeddableEditor interface and therefore can be embedded within Infragistics controls like WinGrid™, WinTree, and WinSchedule controls. This control has a built-in spin button that can be used to increment and decrement the time span values.
