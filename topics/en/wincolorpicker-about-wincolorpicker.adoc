...
image::Images/UltraColorPicker_UltraColorPalette.png[example of ultracolorpicker]

* link:{ApiPlatform}win.ultrawineditors{ApiVersion}~infragistics.win.ultrawineditors.ultracolorpicker~style.html[Style] - Change the style of the color palette.