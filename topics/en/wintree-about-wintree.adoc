...
* Multi-Column Grid -- the {ProductName} 2005 Volume 2 release of the WinTree was able to display columns and cells similar to the WinGrid control.
* ViewStyle -- Allows you to toggle between having a standard tree, to a multi-column tree, to a free-form tree.
* Cell Editing -- Starting in the {ProductName} 2005 Volume 3 release you could edit the cells when the WinTree was data bound and had multiple columns.
