...
*z* というタイトルの 2 つの変数は同等になります。2 番目の表記は計算的にあまり効率的ではありません。加算演算と乗算演算に加えて、 link:{ApiPlatform}math{ApiVersion}~infragistics.math.constant~i.html[Constant.I] の構成が関わるからです。
