...
アプリケーション プログラミング インターフェイス (API) は Windows Forms のコントロールおよびコンポーネントすべての基盤です。「API 参照ガイド」では、Windows Forms アセンブリによって編成された {ProductName} のクラス、列挙体、インターフェイス、デリゲートなどの決定版を提供します。
