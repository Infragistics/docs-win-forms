...
|`3353`
|Schedule
|UltraWinSchedule - 28 日の 2 月において、第 4 平日の予定が生成されない。
...
|`25156`
|Grid
|UltraFormattedTextEditor が Word へのエクスポート時にフォント サイズを無視する。
...
|`40060`
|GridExcelExporter
|MaxExcelRowCount のデータで GridExcelExporter が InvalidOperationException エラーをスローする。

|`40087`
|Map
|UltraGeographicMap - ズーム中にタイル間のギャップが表示される。
